...
public class units {
    ...
    //Super for each unit and basic functionality
    public units(String name, int base_attack, int base_defense, int speed, int cost, int manpower, int build_time){
        this.name = name;
    ...
    public void set_base_defense(int defense){base_defense = defense;}
