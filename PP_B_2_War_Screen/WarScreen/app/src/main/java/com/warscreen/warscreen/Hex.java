...
public class Hex {
        ...
        float ColorT[]={1.0f,0.0f,0.0f,1.0f};
       ...
       //private short lineOrder[]={4,0,1,2,3,4,5,6,7};
        ...
        public Hex(float x1, float y1, float height, float width, int id) {
            ...
            army a=new army(new ArrayList<units>(2),new ArrayList<units>(2),new ArrayList<units>(2),id,0);
            data=new Hex_data(id,a,slow,1,1000,null,null);
        ...
        public void setHexData(Hex_data data){
            this.data=data;
        }
    ...
    public void draw() {
        ...
        if(context==0) {
            ...
            GLES20.glUniform4fv(mColorHandle,1,ColorT,0);
        }
        // Draw the Hexagon
